...
const DEFAULT_MAP_MARKERS: MapMarkerItem[] = [
  ...
  },
  {
    ...
    ideaTemplate: 'Yêu cầu Công an Phường Thủ Dầu Một bố trí lực lượng phân luồng giờ cao điểm Ngã 6 Thủ Dầu Một, kết nối dữ liệu Camera AI giám sát.',
    assignedUnit: 'Công an Phường Thủ Dầu Một & CSGT',
    lat: 10.9842,
    lng: 106.6575,
    isVehicleGPS: true,
  ...
  },
  {
    ...
    ideaTemplate: 'Giao UBND Phường Thủ Dầu Một đôn đốc nhà thầu hoàn thành dứt điểm nạo vét trước mùa mưa bão, hoàn trả mặt bằng sạch đẹp.',
    assignedUnit: 'UBND & Bộ phận Đô thị Phường Thủ Dầu Một',
    lat: 10.9732,
    lng: 106.6502,
    isVehicleGPS: true,
...
export default function DigitalMap() {
  ...
  useEffect(() => {
    ...
    map.on('click', (e: L.LeafletMouseEvent) => {
      ...
      setNewMarkerForm(prev => ({
        ...prev,
        location: `Vị trí tọa độ (${lat.toFixed(4)}, ${lng.toFixed(4)}) - Phường Thủ Dầu Một`,
  ...
  const handleSaveNewPin = async (e: React.FormEvent) => {
    ...
    const newMarker: MapMarkerItem = {
      ...
      location: newMarkerForm.location || 'Địa bàn Phường Thủ Dầu Một',
      wardOrKp: newMarkerForm.wardOrKp || 'Phường Thủ Dầu Một',
